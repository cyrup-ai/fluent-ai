...
//!
//! This module provides comprehensive real-time event types using Arc<str> for
...
impl RealTimeEvent {
    ...
    #[inline]
    pub fn typing_started(user_id: Arc<str>, session_id: Arc<str>) -> Self {
        Self::TypingStarted {
            user_id,
            session_id,
    ...
    #[inline]
    pub fn typing_stopped(user_id: Arc<str>, session_id: Arc<str>) -> Self {
        Self::TypingStopped {
            user_id,
            session_id,
            timestamp: Self::current_timestamp(),
    ...
    #[inline]
    pub fn message_received(message: Message, session_id: Arc<str>) -> Self {
    ...
    #[inline]
    pub fn message_updated(message_id: Arc<str>, content: Arc<str>, session_id: Arc<str>) -> Self {
        Self::MessageUpdated {
            message_id,
            content,
            session_id,
    ...
    #[inline]
    pub fn message_deleted(message_id: Arc<str>, session_id: Arc<str>) -> Self {
        Self::MessageDeleted {
            message_id,
            session_id,
            timestamp: Self::current_timestamp(),
    ...
    #[inline]
    pub fn user_joined(user_id: Arc<str>, session_id: Arc<str>) -> Self {
        Self::UserJoined {
            user_id,
            session_id,
            timestamp: Self::current_timestamp(),
    ...
    #[inline]
    pub fn user_left(user_id: Arc<str>, session_id: Arc<str>) -> Self {
        Self::UserLeft {
            user_id,
            session_id,
            timestamp: Self::current_timestamp(),
    ...
    #[inline]
    pub fn connection_status_changed(user_id: Arc<str>, status: ConnectionStatus) -> Self {
    ...
    #[inline]
    pub fn heartbeat_received(user_id: Arc<str>, session_id: Arc<str>) -> Self {
    ...
    #[inline]
    pub fn system_notification(message: Arc<str>, level: NotificationLevel) -> Self {
...
impl EventFilter {
    ...
    /// Filter by user ID
    #[inline]
    pub fn user_id(mut self, user_id: Arc<str>) -> Self {
    ...
    /// Filter by session ID
    #[inline]
    pub fn session_id(mut self, session_id: Arc<str>) -> Self {
