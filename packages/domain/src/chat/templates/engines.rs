...
pub trait TemplateEngine: Send + Sync {
    ...
    fn render(&self, template: &ChatTemplate, context: &TemplateContext) -> TemplateResult<Arc<str>>;
    ...
    fn render(&self, template: &ChatTemplate, context: &TemplateContext) -> TemplateResult<Arc<str>> {
        ...
        for (name, value) in context.variables() {
            ...
            let replacement = match value {
                ...
                TemplateValue::Boolean(b) => if *b { "true" } else { "false" },
...
impl EngineRegistry {
    ...
    pub fn render(&self, template: &ChatTemplate, context: &TemplateContext) -> TemplateResult<Arc<str>> {
