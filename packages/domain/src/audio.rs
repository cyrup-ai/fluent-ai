...
use crate::chunk::{AudioFormat, SpeechChunk, TranscriptionChunk};
...
pub struct AudioBuilderWithHandler {
    data: String,
    #[allow(dead_code)] // TODO: Use in format validation
    format: Option<ContentFormat>,
    media_type: Option<AudioMediaType>,
    #[allow(dead_code)] // TODO: Use when audio processing errors occur
    error_handler: Box<dyn Fn(String) + Send + Sync>,
    #[allow(dead_code)] // TODO: Use for audio streaming chunk processing
