...
pub struct AgentBuilderWithHandler {
    ...
    max_tokens: Option<u64>,
    additional_params: Option<Value>,
    #[allow(dead_code)] // TODO: Use for model initialization errors and tool failures
    error_handler: Box<dyn Fn(String) + Send + Sync>,
    #[allow(dead_code)] // TODO: Use for agent post-processing 
    result_handler: Option<Box<dyn FnOnce(Agent) -> Agent + Send + 'static>>,
    #[allow(dead_code)] // TODO: Use for streaming agent updates
            ...
            + 'static,
    {
        ...
        tokio::spawn(async move {
            ...
            loop {
                ...
                match chat_result {
                    crate::chat::chat_loop::ChatLoop::Reprompt(response) => {
                    ...
                    crate::chat::chat_loop::ChatLoop::UserPrompt(prompt) => {
                    ...
                    crate::chat::chat_loop::ChatLoop::Break => {
...
pub struct ConversationBuilder {
    #[allow(dead_code)] // TODO: Use when conversation is implemented
    agent: Agent,
    messages: ZeroOneOrMany<Message>,
}
...
impl ConversationBuilder {
    ...
    pub fn converse(self) -> impl AsyncStream<Item = ChatMessageChunk> {
        ...
        let _last_user_message = match &self.messages {
