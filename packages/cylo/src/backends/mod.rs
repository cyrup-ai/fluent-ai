...
impl ExecutionRequest {
    ...
    pub fn with_backend_config<K: Into<String>, V: Into<String>>(mut self, key: K, value: V) -> Self {
...
impl From<BackendError> for CyloError {
    fn from(err: BackendError) -> Self {
        match err {
            ...
            BackendError::InvalidConfig { backend, details } => {
                CyloError::InvalidConfiguration {
                    backend,
            ...
            BackendError::ExecutionTimeout { seconds } => {
...
pub fn create_backend(
    ...
    match env {
        ...
        crate::execution_env::Cylo::Apple(_) => {
            Err(CyloError::platform_unsupported(
                "Apple",
        ...
        crate::execution_env::Cylo::LandLock(_) => {
            Err(CyloError::platform_unsupported(
                "LandLock",
        ...
        #[cfg(not(target_os = "linux"))]
        crate::execution_env::Cylo::FireCracker(_) => {
            Err(CyloError::platform_unsupported(
                "FireCracker",
...
mod tests {
    ...
    fn execution_request_builder() {
        ...
        assert_eq!(request.env_vars.get("TEST_VAR"), Some(&"test_value".to_string()));
    ...
    fn backend_config_builder() {
        ...
        assert_eq!(config.backend_specific.get("custom_option"), Some(&"value".to_string()));
    }
