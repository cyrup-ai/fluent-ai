...
pub struct CertificateConfig {
    ...
    #[allow(dead_code)] // Part of certificate configuration
    pub key_size: usize,
...
pub struct ServiceConfig {
    ...
    pub command: String,
    #[allow(dead_code)] // Part of service configuration
    pub args: Vec<String>,
...
impl InstallContext {
    ...
    #[allow(dead_code)] // Part of public installer API
    ...
    pub fn generate_certificates(&self) -> Result<()> {
        ...
        let not_before = now;
        let not_after = now + time::Duration::seconds((config.validity_days as i64) * 24 * 3600);
