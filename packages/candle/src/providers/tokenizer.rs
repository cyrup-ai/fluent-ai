...
impl CandleTokenizer {
    ...
    pub fn decode_batch(&self, token_sequences: &[&[u32]]) -> Result<Vec<String>, CandleTokenizerError> {
    ...
    fn build_vocab_map(tokenizer: &Tokenizer) -> Result<HashMap<String, u32>, CandleTokenizerError> {
...
pub mod utils {
    ...
    pub fn split_at_token_boundary(text: &str, max_chars: usize) -> (&str, &str) {
        ...
        while split_pos > 0 && !text.chars().nth(split_pos).map_or(false, char::is_whitespace) {
            split_pos -= 1;
        }
