...
impl CandleQwen3CoderProvider {
    ...
    pub fn with_config_sync(
        ...
        log::info!("Qwen3 Coder Provider initialized with SIMD support: {} (vector width: {} elements)", 
        ...
        let model_config = LlamaConfig {
            ...
            eos_token_id: Some(candle_transformers::models::llama::LlamaEosToks::Single(151645)),  // Qwen3 EOS token
            rope_scaling: None,
    ...
    pub fn with_config_sync_gguf(
        ...
        let model_config = LlamaConfig {
            ...
            eos_token_id: Some(candle_transformers::models::llama::LlamaEosToks::Single(eos_token_id)),
            rope_scaling: None,
            tie_word_embeddings: Some(false),
        };
        ...
        AsyncStream::with_channel(move |sender| {
            completion_stream.for_each(|completion_chunk| {
                let message_chunk = match completion_chunk {
                    ...
                    crate::domain::completion::CandleCompletionChunk::Complete { text, .. } => {
                        CandleMessageChunk {
                            content: text,
                            done: true,
                        }
    ...
    fn prompt(&self, prompt: CandlePrompt, params: &CandleCompletionParams) -> AsyncStream<CandleCompletionChunk> {
        ...
        return AsyncStream::with_channel(move |sender| {
            let error_chunk = CandleCompletionChunk::Error(
                "Error: Direct TextGenerator usage not yet implemented in Qwen3CoderProvider. This should use TextGenerator::generate() directly instead of Engine::execute_model_inference().".to_string()
            );
