...
impl Default for CandleIntegrationConfig {
    fn default() -> Self {
        Self {
...
/// Candle integration configuration validator
pub struct CandleIntegrationValidator;

impl CandleConfigurationValidator for CandleIntegrationValidator {
    fn validate(&self, config: &CandleChatConfig) -> CandleConfigurationValidationResult<()> {
...
impl CandleConfigurationManager {
    ...
    pub fn update_config(&self, new_config: CandleChatConfig) -> AsyncStream<()> {
