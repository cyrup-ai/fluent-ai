...
mod tests {
    ...
    fn test_register_and_get() {
        let registry = CandleModelRegistry::new();

        let info = CandleModelInfo::builder()
            .provider_name("test")
            .name("test-model")
            .build()
            .unwrap();
    ...
    fn test_duplicate_registration() {
        ...
        let info1 = CandleModelInfo::builder()
            .provider_name("test")
            .name("test-model")
            .build()
            .unwrap();

        let info2 = CandleModelInfo::builder()
            .provider_name("test")
            .name("test-model")
            .build()
            .unwrap();
        ...
        assert!(matches!(
            result,
            Err(CandleModelError::ModelAlreadyExists {
    ...
    fn test_model_registration() {
        ...
        // Register model directly using CandleModelRegistry
        let mut registry = CandleModelRegistry::new();
