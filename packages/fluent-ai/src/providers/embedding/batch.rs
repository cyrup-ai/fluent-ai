...
use crate::providers::embedding::normalization::{NormalizationMethod, apply_normalization};
...
where
    T: crate::providers::embedding::EnhancedEmbeddingModel + Clone + Send + Sync + 'static,
{
