...
//!
//! Trait-based memory builders following fluent-ai architecture patterns.
...
use fluent_ai_domain::{
    ZeroOneOrMany, 
    memory::{
        MemoryNode, MemoryTypeEnum, MemoryContent, BaseMemory, MemoryMetadata,
        MemoryNodeMetadata, AlignedEmbedding, MemoryResult, MemoryError,
        MemorySystemConfig, DatabaseConfig, VectorStoreConfig, LLMConfig,
        CompatibilityMode, VectorStoreType, EmbeddingConfig, LLMProvider,
...
impl Memory {
    ...
    pub fn system() -> impl MemorySystemBuilder {
        MemorySystemBuilderImpl {
            database_config: ZeroOneOrMany::None,
            vector_config: ZeroOneOrMany::None,
            llm_config: ZeroOneOrMany::None,
            enable_cognitive: ZeroOneOrMany::None,
            compatibility_mode: ZeroOneOrMany::None,
        }
    }
...
impl AdvancedMemorySystemBuilder {
    ...
    pub fn production() -> MemoryResult<impl MemorySystemBuilder> {
        let database_config = DatabaseConfig::new(
            ...
            "postgresql://localhost:5432/fluent_ai_prod",
            "production",
            "memory_prod",
        )?;
