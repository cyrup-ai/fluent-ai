...
impl ProviderTrait for MistralProvider {
    ...
    fn list_models(&self) -> AsyncStream<ModelInfo> {
        ...
        impl From<fluent_ai_http3::BadChunk> for MistralModelsResponse {
        ...
        AsyncStream::with_channel(move |sender| {
            let response = if let Ok(api_key) = env::var("MISTRAL_API_KEY") {
                Http3::json()
                    ...
                    .collect_one::<MistralModelsResponse>()
            } else {
                Http3::json()
                    .get("https://api.mistral.ai/v1/models")
                    .collect_one::<MistralModelsResponse>()
...
fn adapt_mistral_to_model_info(model: &str) -> ModelInfo {
    ...
    let map = MAP.get_or_init(|| {
        ...
        m.insert(
            "mistral-large-2407",
            (128000, 32000, 8.0, 24.0, false, true, true, false, false),
        );
        m.insert(
            "mistral-large-2312",
            (32000, 8000, 3.0, 9.0, false, true, true, false, false),
        );
        m.insert(
            "mistral-small-2409",
            (128000, 32000, 0.2, 0.6, false, true, true, false, false),
        );
        m.insert(
            "mistral-nemo-2407",
            (128000, 32000, 0.2, 0.6, false, true, true, false, false),
        ...
        m.insert(
            "open-mistral-nemo",
            (128000, 32000, 0.3, 1.0, false, true, true, false, false),
        );
        m.insert(
            "codestral-2405",
            (32000, 8000, 0.8, 2.5, false, false, true, false, false),
        );
        m.insert(
            "mistral-embed",
            (8192, 0, 0.1, 0.0, false, false, false, true, false),
        );
        m.insert(
            "mistral-tiny",
            (32000, 8000, 0.25, 0.75, false, false, true, false, false),
        );
        m.insert(
            "mistral-small",
            (32000, 8000, 2.0, 6.0, false, true, true, false, false),
        );
        m.insert(
            "mistral-medium",
            (32000, 8000, 8.0, 24.0, false, true, true, false, false),
        );
        m.insert(
            "mistral-large",
            (32000, 8000, 20.0, 60.0, false, true, true, false, false),
        );
    ...
    let (
        ...
        .get(model)
        .copied()
        .unwrap_or((32000, 8000, 0.0, 0.0, false, false, true, false, false));
    ...
    ModelInfo {
        ...
        real_name: None,
        model_type: if supports_embeddings {
