...
pub fn get_ernie45turbo128k_info() -> ModelInfoData {
    ModelInfoData {
        ...
        max_input_tokens: Some(131072),
        max_output_tokens: None,
        input_price: Some(0.112),
        output_price: Some(0.448),
        supports_vision: None,
        supports_function_calling: None,
        require_max_tokens: None,
    }
...
pub fn get_qwenturbolatest_info() -> ModelInfoData {
    ModelInfoData {
        ...
        max_input_tokens: Some(1000000),
        max_output_tokens: Some(8192),
        input_price: Some(0.042),
        output_price: Some(0.084),
        supports_vision: None,
        supports_function_calling: Some(true),
        require_max_tokens: None,
    }
...
pub fn get_qwen25vl72binstruct_info() -> ModelInfoData {
    ModelInfoData {
        ...
        max_input_tokens: Some(129024),
        max_output_tokens: Some(8192),
        input_price: Some(2.24),
        output_price: Some(6.72),
        supports_vision: Some(true),
        supports_function_calling: None,
        require_max_tokens: None,
    }
...
pub fn get_qwen25coder32binstruct_info() -> ModelInfoData {
    ModelInfoData {
        ...
        max_input_tokens: Some(129024),
        max_output_tokens: Some(8192),
        input_price: Some(0.49),
        output_price: Some(0.98),
        supports_vision: None,
        supports_function_calling: Some(true),
        require_max_tokens: None,
    }
...
/// Get model info for kimi-k2-0711-preview
pub fn get_kimik20711preview_info() -> ModelInfoData {
    ModelInfoData {
        provider_name: "moonshot".to_string(),
