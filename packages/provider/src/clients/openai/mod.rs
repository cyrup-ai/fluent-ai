...
pub mod config {
    ...
    pub const AUDIO_TRANSCRIPTIONS_ENDPOINT: &str = "https://api.openai.com/v1/audio/transcriptions";
...
impl models {
    ...
    pub const fn is_gpt4_model(model: &str) -> bool {
        matches!(model, 
            models::GPT_4_1 | models::GPT_4_1_MINI | models::GPT_4_1_NANO |
            models::GPT_4O | models::GPT_4O_SEARCH_PREVIEW | models::GPT_4O_MINI |
            models::GPT_4O_MINI_SEARCH_PREVIEW | models::CHATGPT_4O_LATEST |
            models::GPT_4_TURBO
        )
    }
    ...
    pub const fn is_o1_model(model: &str) -> bool {
        matches!(model, 
            models::O1_PREVIEW | models::O1_MINI | models::O1_MINI_HIGH |
            models::O3 | models::O3_MINI | models::O3_MINI_HIGH
        )
    }
    ...
    pub const fn is_embedding_model(model: &str) -> bool {
        matches!(model, models::TEXT_EMBEDDING_3_LARGE | models::TEXT_EMBEDDING_3_SMALL)
    }
    ...
    pub const fn supports_function_calling(model: &str) -> bool {
        matches!(model, 
            ...
            models::GPT_4O | models::GPT_4O_SEARCH_PREVIEW | models::GPT_4O_MINI |
            models::GPT_4O_MINI_SEARCH_PREVIEW | models::CHATGPT_4O_LATEST |
            models::GPT_4_TURBO | models::GPT_3_5_TURBO
        )
    }
    ...
    pub const fn is_supported_model(model: &str) -> bool {
        Self::is_gpt4_model(model) || Self::is_gpt3_model(model) || 
        Self::is_o1_model(model) || Self::is_embedding_model(model)
    }
    ...
    pub const fn context_length(model: &str) -> u32 {
        match model {
            ...
            models::O1_PREVIEW | models::O1_MINI | models::O1_MINI_HIGH |
            models::O3 | models::O3_MINI | models::O3_MINI_HIGH => config::O1_MAX_CONTEXT,
    ...
    pub const fn model_tier(model: &str) -> Option<&'static str> {
        match model {
            ...
            models::GPT_4_TURBO | models::TEXT_EMBEDDING_3_LARGE => Some("standard"),
            models::GPT_4_1_NANO | models::GPT_4O_MINI_SEARCH_PREVIEW | models::O1_MINI_HIGH |
            models::O3_MINI_HIGH | models::GPT_3_5_TURBO | models::TEXT_EMBEDDING_3_SMALL => Some("efficient"),
            _ => None,
        }
    }
    ...
    pub const fn temperature_range(model: &str) -> (f32, f32) {
        match model {
            models::O1_PREVIEW | models::O1_MINI | models::O1_MINI_HIGH |
            models::O3 | models::O3_MINI | models::O3_MINI_HIGH => (0.0, 1.0), // O1 models have restricted temperature
    ...
    pub const fn cost_tier(model: &str) -> &'static str {
        match model {
            ...
            models::GPT_4_1_NANO | models::GPT_3_5_TURBO | models::TEXT_EMBEDDING_3_SMALL => "budget",
            _ => "standard",
        }
    }
}
...
pub mod vision {
    ...
    pub const SUPPORTED_DETAIL_LEVELS: &[&str] = &[
        "low", "high", "auto"
    ];
...
pub mod utils {
    ...
    pub fn validate_api_key(api_key: &str) -> Result<(), ArrayString<64>> {
        ...
        if !api_key.chars().all(|c| c.is_alphanumeric() || c == '_' || c == '-') {
            return Err(ArrayString::from("API key contains invalid characters").unwrap_or_default());
        }
    ...
    pub const fn optimal_timeout_ms(model: &str) -> u64 {
        match model {
            ...
            models::GPT_4_1_MINI | models::GPT_4O_MINI | models::O1_MINI | models::O3_MINI => 45_000,
...
mod tests {
    ...
    fn test_model_capabilities() {
        ...
        assert!(!models::supports_function_calling(models::TEXT_EMBEDDING_3_LARGE));
    ...
    fn test_context_length() {
        assert_eq!(models::context_length(models::GPT_4_1), config::GPT4_MAX_CONTEXT);
        assert_eq!(models::context_length(models::GPT_4O), config::GPT4_MAX_CONTEXT);
        assert_eq!(models::context_length(models::GPT_4_TURBO), config::GPT4_MAX_CONTEXT);
        assert_eq!(models::context_length(models::GPT_3_5_TURBO), config::GPT3_MAX_CONTEXT);
        assert_eq!(models::context_length(models::O1_PREVIEW), config::O1_MAX_CONTEXT);
    ...
    fn test_embedding_dimensions() {
        assert_eq!(models::embedding_dimensions(models::TEXT_EMBEDDING_3_LARGE), config::EMBEDDING_3_LARGE_DIMENSIONS);
        assert_eq!(models::embedding_dimensions(models::TEXT_EMBEDDING_3_SMALL), config::EMBEDDING_3_SMALL_DIMENSIONS);
    ...
    fn test_model_families() {
        ...
        assert_eq!(models::model_family(models::TEXT_EMBEDDING_3_LARGE), Some("embedding"));
    ...
    fn test_model_tiers() {
        ...
        assert_eq!(models::model_tier(models::TEXT_EMBEDDING_3_LARGE), Some("standard"));
        ...
        assert_eq!(models::model_tier(models::TEXT_EMBEDDING_3_SMALL), Some("efficient"));
    ...
    fn test_api_key_validation() {
        // Valid API keys
        assert!(utils::validate_api_key("sk-1234567890123456789012345678901234567890123456789012345678").is_ok());
        assert!(utils::validate_api_key("sk-abcdefghijklmnopqrstuvwxyz1234567890ABCDEFGHIJKLMNOPQRSTUVWXYZ").is_ok());
        ...
        assert!(utils::validate_api_key("no-prefix-1234567890123456789012345678901234567890123456789012345678").is_err());
        assert!(utils::validate_api_key("sk-invalid@key#with$special%characters^and&more*").is_err());
    }
    ...
    fn test_endpoint_routing() {
        assert_eq!(endpoints::get_endpoint_for_model(models::GPT_4_1), config::CHAT_COMPLETIONS_ENDPOINT);
        assert_eq!(endpoints::get_endpoint_for_model(models::GPT_4O), config::CHAT_COMPLETIONS_ENDPOINT);
        assert_eq!(endpoints::get_endpoint_for_model(models::O1_PREVIEW), config::CHAT_COMPLETIONS_ENDPOINT);
        assert_eq!(endpoints::get_endpoint_for_model(models::TEXT_EMBEDDING_3_LARGE), config::EMBEDDINGS_ENDPOINT);
        assert_eq!(endpoints::get_endpoint_for_model(models::TEXT_EMBEDDING_3_SMALL), config::EMBEDDINGS_ENDPOINT);
        
        assert_eq!(endpoints::get_transcription_endpoint(), config::AUDIO_TRANSCRIPTIONS_ENDPOINT);
        assert_eq!(endpoints::get_translation_endpoint(), config::AUDIO_TRANSLATIONS_ENDPOINT);
        assert_eq!(endpoints::get_speech_endpoint(), config::AUDIO_SPEECH_ENDPOINT);
    ...
    fn test_token_estimation() {
        ...
        assert!(utils::estimate_token_count("This is a longer text with many words and characters") > 8);
    ...
    fn test_capability_checking() {
        ...
        assert!(utils::supports_capability(models::GPT_4_1, "function_calling"));
        assert!(utils::supports_capability(models::GPT_4O, "function_calling"));
        assert!(!utils::supports_capability(models::O1_PREVIEW, "function_calling"));
        
        assert!(utils::supports_capability(models::GPT_4_1, "streaming"));
        assert!(utils::supports_capability(models::O1_PREVIEW, "streaming"));
        assert!(!utils::supports_capability(models::TEXT_EMBEDDING_3_LARGE, "streaming"));
        
        assert!(utils::supports_capability(models::TEXT_EMBEDDING_3_LARGE, "embedding"));
        assert!(utils::supports_capability(models::TEXT_EMBEDDING_3_SMALL, "embedding"));
    ...
    fn test_optimal_batch_sizes() {
        assert_eq!(utils::optimal_batch_size(models::TEXT_EMBEDDING_3_LARGE, "embedding"), 512);
        assert_eq!(utils::optimal_batch_size(models::TEXT_EMBEDDING_3_SMALL, "embedding"), 1024);
