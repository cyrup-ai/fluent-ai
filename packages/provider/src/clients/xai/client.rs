// ============================================================================
// File: src/providers/xai/client.rs
// ----------------------------------------------------------------------------
...
use super::completion::{CompletionModel, GROK_3, XaiCompletionModel};
...
static XAI_METRICS: LazyLock<XAIMetrics> = LazyLock::new(XAIMetrics::new);

/// xAI performance metrics with atomic counters
#[derive(Debug)]
pub struct XAIMetrics {
...
/// xAI error types for comprehensive error handling
...
impl Client {
    ...
    pub async fn make_request(
        ...
        headers.push((
            "User-Agent",
            ArrayString::from("fluent-ai-xai/1.0").unwrap_or_else(|_| ArrayString::new()),
        ));
...
// ============================================================================
pub struct XAICompletionBuilder<'a, S> {
    client: &'a Client,
    model_name: &'a str,
    // mutable fields
...
// Constructors
// ============================================================================
impl<'a> XAICompletionBuilder<'a, NeedsPrompt> {
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn default_for_chat(client: &'a Client) -> XAICompletionBuilder<'a, HasPrompt> {
        Self::new(client, GROK_3)
            .temperature(0.8)
            .max_tokens(2048)
...
// ============================================================================
impl<'a, S> XAICompletionBuilder<'a, S> {
    #[inline(always)]
...
impl<'a> XAICompletionBuilder<'a, NeedsPrompt> {
    #[inline(always)]
    pub fn prompt(mut self, msg: Message) -> XAICompletionBuilder<'a, HasPrompt> {
        self.prompt = Some(msg);
        XAICompletionBuilder {
            client: self.client,
...
impl<'a> XAICompletionBuilder<'a, HasPrompt> {
    ...
    pub fn execute(
        self,
    ) -> AsyncTask<Result<completion::CompletionResponse<'static>, CompletionError>> {
...
// ============================================================================
impl<'a> Prompt for XAICompletionBuilder<'a, NeedsPrompt> {
    type PromptedBuilder = XAICompletionBuilder<'a, HasPrompt>;
