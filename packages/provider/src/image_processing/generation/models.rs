...
impl ModelManager {
    ...
    fn load_text_encoder(
        ...
        // Create text encoder
        let text_encoder = super::text_encoder::StableDiffusion3TripleClipWithTokenizer::new(var_builder)
            .map_err(|e| ModelError::LoadingError(format!("Text encoder creation failed: {}", e)))?;
    ...
    fn estimate_model_memory(&self, variant: SD3ModelVariant) -> usize {
        super::config::DeviceOptimization::calculate_memory_requirements(
            &GenerationConfig {
