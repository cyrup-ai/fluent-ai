...
mod tests {
    ...
    fn test_no_proxy_from_env() {
        ...
        let no_proxy = super::super::super::NoProxy::from_env();
    ...
    fn test_no_proxy_from_string() {
        let no_proxy = super::super::super::NoProxy::from_string("google.com,192.168.1.0/24");
        assert!(no_proxy.is_some());
        ...
        // Test empty string
        let no_proxy = super::super::super::NoProxy::from_string("");
    ...
    fn test_proxy_with_no_proxy() {
        let proxy = super::super::super::Proxy::all("http://proxy.example.com")
