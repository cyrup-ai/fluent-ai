...
mod tests {
    ...
    fn test_replace_headers() {
        ...
        headers.insert("foo", "bar".parse().expect("test header should parse"));
        headers.append("foo", "baz".parse().expect("test header should parse"));
    ...
    fn convert_from_http_request() {
        ...
        let req: Request = Request::try_from(http_request).expect("test should succeed");
        assert!(req.body().is_some());
        let test_data = b"test test test";
        assert_eq!(req.body().expect("test should succeed").as_bytes(), Some(&test_data[..]));
        let headers = req.headers();
        assert_eq!(headers.get("User-Agent").expect("test should succeed"), "my-awesome-agent/1.0");
        assert_eq!(req.method(), Method::GET);
    ...
    fn builder_split_reassemble() {
        ...
        let request = inner.expect("test should succeed");
        let builder = RequestBuilder::from_parts(client, request);
        builder.build().expect("test should succeed");
    }
    ...
    fn basic_get_request() {
        let client = Client::new().expect("test should succeed");
        let some_url = "https://google.com/";
        let r = client.get(some_url).expect("test should succeed").build();
    ...
    fn basic_head_request() {
        let client = Client::new().expect("test should succeed");
        let some_url = "https://google.com/";
        let r = client.head(some_url).expect("test should succeed").build();
    ...
    fn basic_post_request() {
        let client = Client::new().expect("test should succeed");
        let some_url = "https://google.com/";
        let r = client.post(some_url).expect("test should succeed").build();
    ...
    fn basic_put_request() {
        let client = Client::new().expect("test should succeed");
        let some_url = "https://google.com/";
        let r = client.put(some_url).expect("test should succeed").build();
    ...
    fn basic_patch_request() {
        let client = Client::new().expect("test should succeed");
        let some_url = "https://google.com/";
        let r = client.patch(some_url).expect("test should succeed").build();
    ...
    fn basic_delete_request() {
        let client = Client::new().expect("test should succeed");
        let some_url = "https://google.com/";
        let r = client.delete(some_url).expect("test should succeed").build();
    ...
    fn add_header() {
        let client = Client::new().expect("test should succeed");
        let some_url = "https://google.com/";
        let mut r = client.post(some_url).expect("test should succeed");
    ...
    fn add_body() {
        ...
        let buf = body::read_to_string(r.body.expect("test should succeed")).expect("test should succeed");
    ...
    fn add_form() {
        ...
        let r = r.form(&form_data).expect("test should succeed").build();
        ...
        let body_should_be = serde_urlencoded::to_string(&form_data).expect("test should succeed");
    ...
    fn add_json() {
        ...
        let r = r.json(&json_data).expect("test should succeed").build();
        ...
        let body_should_be = serde_json::to_string(&json_data).expect("test should succeed");
        assert_eq!(buf, body_should_be);
    }
