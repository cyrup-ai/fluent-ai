...
#[inline]
pub fn bytes_to_string(bytes: Bytes) -> HttpResult<String> {
    String::from_utf8(bytes.to_vec()).map_err(|e| crate::error::HttpError::DeserializationError {
        message: e.to_string(),
    })
}
...
#[inline]
pub fn bytes_to_str(bytes: &Bytes) -> HttpResult<&str> {
    std::str::from_utf8(bytes).map_err(|e| crate::error::HttpError::DeserializationError {
...
#[inline]
pub fn convert<T, U>(value: T) -> HttpResult<U>
where
    T: TryInto<U>,
    T::Error: std::fmt::Display,
{
    value
        .try_into()
        .map_err(|e| crate::error::HttpError::DeserializationError {
