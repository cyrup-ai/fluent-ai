...
impl CrlCache {
    ...
    fn download_and_parse_crl_sync(&self, crl_url: &str) -> Result<CrlCacheEntry, TlsError> {
        // Download CRL using high-level Http3 builder API
