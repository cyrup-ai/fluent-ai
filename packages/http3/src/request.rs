...
impl HttpRequest {
    ...
    pub fn cache_control(mut self, cache_control: String) -> Self {
        self.headers.insert("Cache-Control".to_string(), cache_control);
        self
    }
    ...
    pub fn accept_encoding(mut self, accept_encoding: String) -> Self {
        self.headers.insert("Accept-Encoding".to_string(), accept_encoding);
        self
    }
    ...
    pub fn streaming(mut self) -> Self {
        self.headers.insert("Accept".to_string(), "text/event-stream".to_string());
