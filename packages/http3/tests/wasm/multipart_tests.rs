...
use fluent_ai_http3_client::wasm::multipart::{Form, Part};
...
fn test_multipart_js() {
    ...
    let form_data = fluent_ai_http3_client::wasm::promise::<FormData>(form_data_promise)
        .collect()
        .into_iter()
        .find(|v| !v.is_error())
    ...
    let text = fluent_ai_http3_client::wasm::promise::<JsValue>(text_promise)
        .collect()
        .into_iter()
        .find(|v| !v.is_error())
    ...
    let array_buffer = fluent_ai_http3_client::wasm::promise::<JsValue>(binary_array_buffer_promise)
        .collect()
        .into_iter()
        .find(|v| !v.is_error())
