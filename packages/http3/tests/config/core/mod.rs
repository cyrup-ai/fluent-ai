//! Tests for HTTP configuration core functionality
//!
//! Tests for HttpConfig defaults, builder methods, and configuration validation

use std::time::Duration;

use fluent_ai_http3::config::core::{ConnectionReuse, HttpConfig, RetryPolicy, RetryableError};
