...
use serde_json::json;
use fluent_ai_http3_client::jsonpath::functions::function_evaluator::regex_functions::core::{evaluate_match_function, evaluate_search_function};
use fluent_ai_http3_client::jsonpath::parser::{FilterExpression, FilterValue};

// Mock evaluator for testing
fn mock_evaluator(
    _context: &serde_json::Value,
    expr: &fluent_ai_http3_client::jsonpath::parser::FilterExpression,
