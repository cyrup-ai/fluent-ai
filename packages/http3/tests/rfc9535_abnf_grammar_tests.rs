...
mod abnf_grammar_tests {
    ...
    fn test_dot_notation_syntax_validation() {
        ...
        let dot_notation_tests = vec![
            ...
            ("$.store.key-with-dashes", true, "Hyphens in identifiers (valid)"),
    ...
    fn test_comparison_operators_syntax() {
        ...
        let comparison_tests = vec![
            ...
            ("$.store.book[?@.price != 8.95]", true, "Not equal operator !="),
            ("$.store.book[?@.price < 10]", true, "Less than operator <"),
            ("$.store.book[?@.price <= 10]", true, "Less than or equal <="),
            ("$.store.book[?@.price > 10]", true, "Greater than operator >"),
            ("$.store.book[?@.price >= 10]", true, "Greater than or equal >="),
            
            // String comparisons
            ("$.store.book[?@.category == 'fiction']", true, "String equality"),
            ("$.store.book[?@.category != 'fiction']", true, "String inequality"), 
            ...
            ("$.store.book[?@.price = 8.95]", false, "Single equals (assignment)"),
            ("$.store.book[?@.price <> 8.95]", false, "Not equal variant <>"),
            ("$.store.book[?@.price === 8.95]", false, "Triple equals"),
            ("$.store.book[?@.price !== 8.95]", false, "Not triple equals"),
    ...
    fn test_bracket_notation_escape_sequences() {
        ...
        let escape_tests = vec![
            ...
            ("$[\"key\\\"with\\\"quotes\"]", true, "Escaped double quotes"),
            ("$['key\\nwith\\nnewlines']", true, "Escaped newlines"),
            ("$['key\\twith\\ttabs']", true, "Escaped tabs"),
            ("$['key\\\\with\\\\backslashes']", true, "Escaped backslashes"),
            ...
            ("$['key\\uD83D\\uDE00']", true, "Unicode emoji (surrogate pair)"),
            
            // Special characters that need escaping
            ("$['key.with.dots']", true, "Dots in quoted property"),
            ("$['key/with/slashes']", true, "Slashes in quoted property"),
            ("$['key[with]brackets']", true, "Brackets in quoted property"),
            ("$['key(with)parens']", true, "Parentheses in quoted property"),
            ("$['key{with}braces']", true, "Braces in quoted property"),
            ("$['key@with@ats']", true, "At symbols in quoted property"),
            ("$['key$with$dollars']", true, "Dollar signs in quoted property"),
    ...
    fn test_abnf_grammar_execution() {
        ...
        let execution_tests = vec![
            ...
            ("$['store']['book'][0]['author']", 1, "Bracket notation execution"),
...
mod abnf_edge_cases {
    ...
    fn test_complex_property_names() {
        ...
        let complex_property_tests = vec![
            ...
            ("$['property-with-everything_123.test@example.com']", true, "Complex mixed property"),
    ...
    fn test_abnf_whitespace_handling() {
        ...
        let whitespace_tests = vec![
            ...
            ("$.store.book[?@.price == 8.95 ]", true, "Space before closing bracket"),
            ("$.store.book[ ?@.price == 8.95]", true, "Space after opening bracket"),
    ...
    fn test_abnf_number_formats() {
        ...
        let number_tests = vec![
            ...
            ("$.store.book[?@.price == 8.95]", true, "Decimal in comparison"),
            ("$.store.book[?@.price == 0.5]", true, "Decimal less than 1"),
            ("$.store.book[?@.price == 123.456]", true, "Multi-digit decimal"),
            ("$.store.book[?@.price == -12.34]", true, "Negative decimal"),
            
            // Scientific notation in filters
            ("$.store.book[?@.price == 1e2]", true, "Scientific notation"),
            ("$.store.book[?@.price == 1.23e-4]", true, "Scientific with decimal"),
            ("$.store.book[?@.price == -1.5E+3]", true, "Scientific negative"),
