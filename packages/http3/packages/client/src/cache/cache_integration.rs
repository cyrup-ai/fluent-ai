            ...
            if response.is_error() {
                ...
                fluent_ai_async::spawn_task(move || {
                    ...
                    for header in headers_stream {
                        ...
                        fluent_ai_async::emit!(forward_headers_tx, header);
                    }
                    ...
                    for trailer in trailers_stream {
                        ...
                        fluent_ai_async::emit!(forward_trailers_tx, trailer);
                    }
                    ...
                    if total_size > 0 && total_size <= MAX_CACHE_SIZE {
                        ...
                        if !cached_body_data.is_empty() {
                            ...
                            fluent_ai_async::emit!(cache_body_tx, cached_body_chunk);
                        }
                                ...
                                handle.block_on(async move {
                                    match super::CacheEntry::new(cached_response).await {
                                        cache_entry => {
                                            ...
                                            tracing::debug!(
                                                target: "fluent_ai_http3::cache::integration",
                ...
                fluent_ai_async::emit!(sender, forwarded_response);
            }
        }
    })
}
