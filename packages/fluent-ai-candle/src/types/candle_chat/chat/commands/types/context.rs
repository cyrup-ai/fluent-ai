//! Command context and output types
//!
//! Provides command execution context and output structures with zero-allocation
//! patterns and comprehensive resource tracking for optimal performance.
