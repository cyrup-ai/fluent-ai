//! Command handler trait and implementations
//!
//! Provides the command handler trait and default implementation for zero-allocation
...
// Removed unused import: OutputType
