...
pub struct CommandRegistry {
    ...
    commands: Arc<SkipMap<Arc<str>, CommandInfo>>,
...
impl CommandRegistry {
    ...
    pub fn register(&self, info: CommandInfo) -> Result<(), CommandError> {
        ...
        for alias in &info.aliases {
            self.aliases
                .insert(Arc::from(alias.as_str()), command_name.clone());
        }
...
pub struct CommandRegistryStats {
    ...
    pub category_counts: std::collections::HashMap<Arc<str>, usize>}
...
pub fn register_global_command(info: CommandInfo) -> Result<(), CommandError> {
...
pub fn get_global_suggestions(prefix: &str) -> Vec<Arc<str>> {
