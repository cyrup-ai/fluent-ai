//! Core types and data structures for search indexing
//!
//! This module provides the fundamental types used for inverted index construction
//! and maintenance with SIMD-optimized text processing.
...
use super::super::types::{SearchQuery, SearchResult, SearchStatistics, MatchPosition,
    MatchType, SortOrder, TermFrequency, QueryOperator, SearchResultMetadata};
...
impl std::fmt::Debug for ChatSearchIndex {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.debug_struct("ChatSearchIndex")
            ...
            .field(
                "simd_threshold",
                &self.simd_threshold.load(std::sync::atomic::Ordering::Relaxed),
            )
            .finish()
    }
}
