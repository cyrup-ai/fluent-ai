//! Message indexing operations with streaming support
//!
//! This module provides functionality for adding messages to the search index
//! with SIMD-optimized processing and lock-free data structures.
...
use super::types::{ChatSearchIndex, IndexEntry, handle_error};
