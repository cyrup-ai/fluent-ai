...
use crate::model::error::{CandleModelError, CandleResult};
...
impl CandleModelInfo {
    ...
    pub fn to_capabilities(&self) -> crate::model::capabilities::CandleModelCapabilities {
        crate::model::capabilities::CandleModelCapabilities {
...
mod tests {
    ...
    fn test_model_info_validation() {
        ...
        let err = ModelInfo::builder()
            ...
            .build()
            .unwrap_err();
        assert!(matches!(err, CandleModelError::InvalidConfiguration(_)));
        ...
        // Thinking without budget - this is validated by the builder
        let model = ModelInfo::builder()
            .provider_name("test")
            .name("test")
            .with_thinking(100)
    ...
    fn test_provider_models() {
        ...
        assert!(matches!(
            err,
            CandleModelError::InvalidConfiguration("model provider does not match collection provider")
        ));
