...
impl Memory {
    ...
    pub fn node() -> impl MemoryNodeBuilder {
        MemoryNodeBuilderImpl {
            id: ZeroOneOrMany::Zero,
            memory_type: ZeroOneOrMany::Zero,
            content: ZeroOneOrMany::Zero,
            embedding: ZeroOneOrMany::Zero,
            importance: ZeroOneOrMany::Zero,
            creation_time: ZeroOneOrMany::Zero,
            last_accessed: ZeroOneOrMany::Zero,
            keywords: ZeroOneOrMany::Zero,
            tags: ZeroOneOrMany::Zero,
            custom_metadata: ZeroOneOrMany::Zero,
        }
    }
