...
fn test_merge_strategies() {
    use fluent_ai_candle::sampling::composite::parallel::MergeStrategy;
...
fn test_preset_chains() -> Result<(), Box<dyn std::error::Error>> {
    use fluent_ai_candle::sampling::composite::builder::presets;
...
fn test_repetition_penalty_static() {
    ...
    CompositeProcessor::apply_repetition_penalty_static(
        &mut logits,
        &token_ids,
        3,
    );
