...
use crate::similarity::metrics::{SimilarityMetrics, SimilarityMetricsSnapshot, MetricsGuard};
use std::sync::Arc;
...
impl CosineSimilarity for Avx512Similarity {
    ...
    fn cosine_similarity(&self, a: &[f32], b: &[f32]) -> f32 {
        ...
        let (dot, norm_a, norm_b) = if Self::is_suitable_length(a.len()) && super::is_avx512f_available() {
