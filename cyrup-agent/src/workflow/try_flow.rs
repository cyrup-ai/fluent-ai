...
pub trait TryOp: Send + Sync {
    ...
    #[inline]
    fn map_ok<F, O>(self, f: F) -> MapOk<Self, op::Map<F, Self::Output>>
    where
    ...
    #[inline]
    fn and_then<F, Fut, O>(self, f: F) -> AndThen<Self, op::Then<F, Self::Output>>
    where
    ...
    #[inline]
    fn map_err<F, E2>(self, f: F) -> MapErr<Self, op::Map<F, Self::Error>>
    where
    ...
    #[inline]
    fn or_else<F, Fut, E2>(self, f: F) -> OrElse<Self, op::Then<F, Self::Error>>
    where
...
impl<A, B> op::Op for AndThen<A, B>
where
    A: TryOp,
...
impl<A, B> op::Op for TrySequential<A, B>
where
    A: TryOp,
    B: Op<Input = A::Output>,
{
