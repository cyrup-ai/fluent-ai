...
impl CompletionProvider {
    ...
    pub fn openai() -> ModelSelector<crate::providers::openai::completion::CompletionModel> {
        ModelSelector::new()
    }

    /// Start fluent chain with Anthropic provider  
    pub fn anthropic() -> ModelSelector<crate::providers::anthropic::completion::CompletionModel> {
        ModelSelector::new()
    }
}
...
// ============================================================================
pub struct ModelSelector<M: CompletionModel> {
    _phantom: PhantomData<M>,
}

impl<M: CompletionModel> ModelSelector<M> {
    fn new() -> Self {
        Self {
...
// ============================================================================
pub struct AgentBuilder<M: CompletionModel, S, C> {
...
impl<M: CompletionModel> AgentBuilder<M, MissingSys, MissingCtx> {
...
impl<M: CompletionModel> AgentBuilder<M, (), MissingCtx> {
...
impl<M: CompletionModel> AgentBuilder<M, (), Ready> {
    ...
    pub fn build(self) -> super::Agent<M> {
